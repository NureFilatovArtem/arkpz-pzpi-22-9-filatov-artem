...
const startServer = async () => {
  try {
    ...
    const buildingRoutes = require('./backend/routes/buildingRoutes');
    const sensorRoutes = require('./backend/routes/sensorRoutes');
    const measurementRoutes = require('./backend/routes/measurementRoutes');
    const officeRoutes = require('./backend/routes/officeRoutes');
